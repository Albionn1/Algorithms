...
if zgjedhja == 1:
    code_ToPrintQuickSort = """
------------------------------ Kodi i Algoritmit QuickSort ------------------------------
...
------------------------------ Perfundimi i kodit te Algoritmit QuickSort ------------------------------
    """
    print("---------------------------------------------------------------------------------------------\n\nArray i sortuar:")
    print(quicksort(lista)),
    print(code_ToPrintQuickSort)

    #Perseritja e sortimit pas shfaqjes se kodit

    print("---------------------------------------------------------------------------------------------\n\nArray i sortuar:")
    print(quicksort(lista))

elif zgjedhja == 2:
    code_ToPrintMergeSort = """
------------------------------ Kodi i Algoritmit MergeSort ------------------------------
...
------------------------------ Perfundimi i Algoritmit MergeSort ------------------------------
    """
    mergeSort(lista, 0, n-1)
    print("---------------------------------------------------------------------------------------------\n\nArray i sortuar:")
    for i in range(n):
        print("%d" % lista[i],end=" ")
    print(code_ToPrintMergeSort)
    ...
    code_ToPrintBubbleSort = """
------------------------------ Kodi i Algoritmit BubbleSort ------------------------------
...
------------------------------ Perfundimi i Algoritmit BubbleSort ------------------------------
    """
    bubblesort(lista)
    print ("---------------------------------------------------------------------------------------------\n\nArray i sortuar:")
    for i in range(len(lista)):
        print(lista[i], end=" ")
    print(code_ToPrintBubbleSort)
